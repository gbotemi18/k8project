...
class IPAddressService:
    ...
    @staticmethod
    def process_ip_request(db: Session, client_ip: str, user_agent: Optional[str] = None) -> dict:
        """
    ...
    def get_ip_history(db: Session, limit: int = 50, offset: int = 0) -> dict:
        ...
        try:
            ...
            for record in records:
                history_records.append(IPAddressHistory(
                    id=record.id,
    ...
    def get_statistics(db: Session) -> dict:
        ...
        try:
            ...
            latest_request = db.query(IPAddress)\
                .order_by(desc(IPAddress.timestamp))\
                .first()
            ...
            recent_requests = db.query(IPAddress)\
                .filter(IPAddress.timestamp >= yesterday)\
                .count()
